...
{
    public abstract class TrafficManagementBusinessCoreWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static TrafficManagementBusinessCoreWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(TrafficManagementBusinessCoreWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<TrafficManagementBusinessCoreDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<TrafficManagementBusinessCoreDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<TrafficManagementBusinessCoreDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<TrafficManagementBusinessCoreDbContext, Task<T>> func)
        {
            T result;
