...
using TrafficManagementBusinessCore.Users;
using TrafficManagementBusinessCore.Users.Dto;

namespace TrafficManagementBusinessCore.Tests.Users
{
    public class UserAppService_Tests : TrafficManagementBusinessCoreTestBase
    {
